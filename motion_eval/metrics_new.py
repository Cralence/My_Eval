...
# T x72 -->32 
    ...
    print(pred_features_m.mean(axis=0)[:15])
    print(gt_freatures_k.std(axis=0)[:15])
    print(pred_features_k.std(axis=0)[:15])
    print(gt_freatures_m.std(axis=0)[:15])
...
def calculate_avg_distance(feature_list, mean=None, std=None):
    ...
    for i in range(n):
        for j in range(i + 1, n):
            ...
            # if curr_dist > 10000:
            #     print(f'{feature_list.shape}, i: {i}, j: {j}, {feature_list[i] - feature_list[j]}')
...
if __name__ == '__main__':
    ...
    # {'fid_k': 169.92931773364077, 'fid_m': 116.723685752069, 'div_k': 16.769304321520917, 'div_m': 9.502102176706153, 'div_k_gt': 9.250034450753242, 'div_m_gt': 7.342270033142343}
